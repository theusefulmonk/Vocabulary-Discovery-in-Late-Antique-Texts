...
glob. The shell expands the star character to any string of any length,
...
translation of Ephrem's \emph{Diatessaron} commentary, we could add that
to the regex, using the pipe character.
