...
Nativity} with the filename
\VERB|\NormalTok{hdn{-}ocr{-}optimized.pdf}|, then we first examine the
scan to determine the absolute page numbers of each section requiring
distinct pagination:
