...
\includepdf[pages=1]{jacques-split.pdf} %% Filename must be without spaces.
...
\includepdf[pages=2-47]{jacques-split.pdf} %% Filename must be without spaces.
...
\includepdf[pages=48-]{jacques-split.pdf} %% Filename must be without spaces.
